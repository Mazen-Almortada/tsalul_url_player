...
class _VideoPlayerScreenState extends State<VideoPlayerScreen> {
      ...
      drmConfiguration:
          current.drm?.license != null
              ? BetterPlayerDrmConfiguration(
                drmType: _getDrmType(current.drm?.type ?? 'clearkey'),
  ...
  void dispose() {
    ...
    // Reset preferred orientations when disposing
    SystemChrome.setPreferredOrientations([
    ...
    final newSource = BetterPlayerDataSource(
      ...
      drmConfiguration:
          quality.drm?.license != null
              ? BetterPlayerDrmConfiguration(
                drmType: _getDrmType(quality.drm?.type ?? 'clearkey'),
...
BetterPlayerDrmType _getDrmType(String type) {
